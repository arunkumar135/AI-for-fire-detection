...
main = tk.Tk()
main.title("ARTIFICIAL INTELLIGENCE APPROACH FOR FIRE DETECTION FROM IMAGES")
main.geometry("1600x1300")
title = tk.Label(main, text="ARTIFICIAL INTELLIGENCE APPROACH FOR FIRE DETECTION FROM IMAGES",justify='center')
